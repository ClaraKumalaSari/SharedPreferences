...
import java.util.List;
    ...
    public class DatabaseHelper extends SQLiteOpenHelper implements Database {
        ...
        // Database Name
        private static final String DATABASE_NAME = DatabaseContens.DATABASE.toString();
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + DatabaseContens.TABLE_USERS + "("
            ...
            Log.d("CREATE DATABASE", "Create " + DatabaseContens.TABLE_USERS + " Successfully.");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + DatabaseContens.TABLE_USERS);
